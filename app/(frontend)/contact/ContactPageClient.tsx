...
export default function ContactPageClient({ contactEmail }: { contactEmail: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // FormSubmit AJAX endpoint - the recipient address is managed in the CMS
      // (Site Settings > Contact Email), not hardcoded here.
